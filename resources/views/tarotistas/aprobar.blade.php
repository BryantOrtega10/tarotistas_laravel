...
@section('title', 'Aprobar Tarotista')

@section('content_header')
    <h1>Aprobar Tarotista</h1>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('tarotistas.lista') }}">Tarotistas</a></li>
            <li class="breadcrumb-item active" aria-current="page">Aprobar o Rechazar</li>
        </ol>
    </nav>
@stop
...
@section('content')
    <form method="post" id="formAprobar">
        ...
        <div class="text-right pb-5">
            <input type="button" id="btnAprobar" class="btn btn-lg btn-primary" value="Aprobar" />
            <input type="hidden" value="{{ route('tarotistas.aprobar', ['id' => $tarotista->id]) }}" id="urlAprobar"/>
            <input type="button" id="btnRechazar" class="btn btn-lg btn-danger" value="Rechazar" />
            <input type="hidden" value="{{ route('tarotistas.rechazar', ['id' => $tarotista->id]) }}" id="urlRechazar"/>
        </div>
    </form>
...
@section('js')
    <script src="/js/tarotista/aprobar.js"></script>
