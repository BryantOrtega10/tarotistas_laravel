            ...
            <div class="card-body">
                    ...
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nombre') is-invalid @enderror" id="nombre"
                                name="nombre" placeholder="Nombre:" value="{{ old('nombre', $pais->nombre) }}">
                            @error('nombre')
                ...
                <div class="col-md-3 col-12">
                    <div class="form-group">
                        ...
                        <input type="file" class="@error('bandera') is-invalid @enderror" id="bandera"
                            name="bandera" accept="image/*">
                        @error('bandera')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
