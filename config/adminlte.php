...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Especialidades',
            'can' => 'web.especialidades',
            'route' => 'especialidades.lista',
            'active' => ['especialidades*'],
            'icon' => 'fas fa-tags',
        ],
        [
            'text' => 'Paises y bancos',
            'can' => 'web.paises',
            'route' => 'paises.lista',
            'active' => ['paises*'],
