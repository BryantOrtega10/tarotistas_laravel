...
class HistorialPagosController extends Controller
{
    ...
    {
        return view('historial_pagos.lista');
    }
    ...
    public function datatableAjax(Request $request)
    {
        ...
        foreach ($tarotistas as $tarotista) {
            ...
            $filteredRecord["accion"]["href"] = route('historialPagos.detalle', ['idTarotista' => $tarotista->id]);
    ...
    public function mostrarDetalleHistorial($idTarotista)
    {
        ...
        return view('historial_pagos.historial', compact('pagos','tarotista', 'bancos'));
    }
}
